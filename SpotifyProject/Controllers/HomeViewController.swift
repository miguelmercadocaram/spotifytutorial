...
//  SpotifyProject
//
//  Created by Pelayo Mercado on 11/12/21.
//
...
extension HomeViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        case .recommendedTracks(viewModels: let viewModels):
            ...
            print("RECOMMENDED TRACK PRESSED")
        }
    }
    ...
    public static func createSectionLayout(section: Int) -> NSCollectionLayoutSection {
        ...
        case 0:
            ...
            let horizontalGroup = NSCollectionLayoutGroup.horizontal(layoutSize: NSCollectionLayoutSize(widthDimension: .fractionalWidth(0.90), heightDimension: .absolute(360)), subitem: verticalGroup, count: 1)
